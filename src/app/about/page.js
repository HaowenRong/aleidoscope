      ...
      <div className='content'>
        ...
        <div className='about-card'>
          ...
          <p className='about-desc'>
            I’m Alex, a photography hobbyist who loves exploring the world and taking some photos along the way. I mainly take photos of landscapes and scenery but I’ll take pictures of anything I find interesting.
          </p>
        </div>
        ...
        <div className='about-card'>
          ...
          <p className='about-desc'>
            This site was developed using Next.js and hosted on Vercel, with images stored on Supabase database. More details can found in the GitHub repository.
          </p>
        </div>
